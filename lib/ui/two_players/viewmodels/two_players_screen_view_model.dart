...
class TwoPlayersScreenViewModel extends Equatable {
  ...
  static build(Store<AppState> store) {
    DebugUtils.debugPrint("TwoPlayersScreenViewModel => build: ${DateTime.now()}");
    return TwoPlayersScreenViewModel(
